      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="border border-terminal-green bg-terminal-black/80 p-6 hover:bg-terminal-green/5 transition-colors"
            >
              <h3 className="text-2xl font-display text-terminal-green mb-3 flex items-start">
                <span className="mr-3 text-terminal-green/60">&gt;</span>
                {faq.question}
              </h3>
              <p className="font-body text-lg text-terminal-green/80 pl-8 leading-relaxed">
                {faq.answer}
              </p>
            </div>
          ))}
