      ...
      <section className="py-24 overflow-hidden border-t-2 border-terminal-primary bg-terminal-black relative">
        ...
        <div className="container px-4 mx-auto">
          <a className="relative z-10 inline-block mb-20" href="/">
            <div className="text-3xl font-bold tracking-wider text-terminal-primary font-display">
              &gt; TRIGGERNOTE_
            </div>
          </a>
          <div className="flex flex-wrap items-end -m-8 mb-20">
            <div className="w-full md:w-1/2 p-8">
              <div className="md:max-w-md">
                <h3 className="mb-10 text-3xl text-terminal-primary uppercase tracking-tighter font-display">
                ...
                <div className="relative border-2 border-terminal-primary focus-within:shadow-[0_0_15px_rgba(var(--terminal-primary-rgb),0.5)] transition-shadow">
                  ...
                  />
                  <a
                    className="absolute right-0 top-0 flex items-center justify-center px-8 h-full bg-terminal-primary hover:bg-terminal-black text-terminal-black hover:text-terminal-primary border-l-2 border-terminal-primary transition-colors group font-display font-bold text-xl uppercase tracking-wider"
                    href="#"
                  >
                     [ SUBMIT ]
                  </a>
              ...
              <div className="flex flex-wrap md:justify-end -m-8 lg:-m-20">
                {data.navGroups?.map((group) => (
                  <div key={group.id} className="w-full md:w-auto p-8 lg:p-20">
                    <h3 className="mb-6 text-xl text-terminal-primary font-bold uppercase underline underline-offset-4 decoration-2 font-display">
                      {group.label}
                    </h3>
                    <ul>
